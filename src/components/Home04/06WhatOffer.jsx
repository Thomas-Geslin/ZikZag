...
import slide1 from '../../public/assets/About/slide_01.jpg'
import slide2 from '../../public/assets/About/slide_02.jpg'
import slide3 from '../../public/assets/About/slide_03.jpg'
import icon1 from '../../public/assets/About/slide_01_icon.png'
import icon2 from '../../public/assets/About/slide_02_icon.png'
import icon3 from '../../public/assets/About/slide_03_icon.png'
import dot from '../../public/assets/Home04/about_dot.png'

export default function WhatOfferHome04() {
    return(
        <section className='text-center'>
            <h2 className='text-orange font-bold mb-4 relative w-40 m-auto max-xl:pt-36 850:mt-12'><span className='absolute bottom-1 left-1 bg-orange h-0.5 w-2'></span>WHAT WE OFFER<span className='absolute bottom-1 ml-1 bg-orange h-0.5 w-2'></span></h2>
            <h3 className='font-Amiri text-slightGrey text-6xl mb-5'>Meet Our Team</h3>
            ...
            <div className='flex justify-center relative '>
                <Image src={dot} alt='point de décoration' className='absolute bottom-96 left-20' />
