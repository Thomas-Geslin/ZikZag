        ...
        <section id='goTopViewport' className='text-center max-w-[1840px] ml-auto mr-auto bg-darkBlueBackground mx-8 rounded-3xl mb-20 relative'>
            ...
            <div className='flex w-2/3 justify-between m-auto pb-24 relative'>
                <div className='text-white text-left bg-darkBlueBackground shadow-[6px_5px_30px_0px_rgb(0,0,0,0.12)] rounded-lg pl-10 mx-4 hover:bg-white ease-in-out duration-500 group'>
                    ...
                    <div className='flex items-center group/arrow relative max-xl:mb-10'><span className='w-10 h-0.5 bg-orange absolute scale-x-0 group/arrow-hover:scale-x-100 origin-left ease-in-out duration-500'></span><span className='w-3 h-0.5 top-[9px] left-[28px] bg-orange absolute scale-x-0 group/arrow-hover:rotate-45 group/arrow-hover:scale-x-100 ease-linear duration-300 delay-500 origin-right'></span><span className='w-3 h-0.5 bg-orange absolute left-[28px] scale-x-0 group/arrow-hover:-rotate-45 group/arrow-hover:scale-x-100 ease-linear duration-300 delay-500 origin-right'></span><p className='text-sm text-orange font-semibold pl-1 group/arrow-hover:translate-x-10 ease-in-out duration-500'>READ MORE</p></div>
                </div>
