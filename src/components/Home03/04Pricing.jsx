...
export default function PricingHome03() {
    return(
        <section className='text-center relative z-10'>
            <h2 className='text-orange font-bold mb-4 pt-32 relative w-40 m-auto max-xl:pt-36 850:mt-12 1050:pt-0'><span className='absolute bottom-1 -left-2 bg-orange h-0.5 w-2'></span>PRICING PACKAGES<span className='absolute bottom-1 ml-1 bg-orange h-0.5 w-2'></span></h2>
            ...
            <div className='flex justify-center w-[60%] m-auto 1050:flex-col 1050:items-center'>
                ...
                <div className='bg-darkBlueBackground mx-10 text-white text-left w-[32%] max-w-[370px] min-w-[300px] relative shadow-[3px_3px_20px_3px_#eae9e9] rounded-lg pl-11 1050:my-6'>
