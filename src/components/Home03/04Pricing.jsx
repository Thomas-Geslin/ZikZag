    ...
    return(
        <section className='text-center mb-40'>
            ...
            <div className='flex justify-between w-[60%] m-auto'>
                <div className='text-left w-[32%] relative shadow-[3px_3px_20px_3px_#eae9e9] rounded-lg pl-11'>
                ...
                <div className='bg-darkBlueBackground text-white text-left w-[32%] relative shadow-[3px_3px_20px_3px_#eae9e9] rounded-lg pl-11'>
