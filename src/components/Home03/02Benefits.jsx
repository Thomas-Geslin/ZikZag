            ...
            <div id='goTopViewport' className='bg-greyBackground'>
                    ...
                    <div className='ml-[7%] mt-36 850:mt-14'>
                        ...
                        <div className='mt-12 flex w-2/3 min-w-[570px] 650:flex-col 650:min-w-fit'>
                            <div>
                                ...
                                <div className='flex items-center group relative max-xl:mb-10'><span className={`w-10 h-0.5 bg-${color} absolute scale-x-0 group-hover:scale-x-100 origin-left ease-in-out duration-500`}></span><span className={`w-3 h-0.5 top-[9px] left-[28px] bg-${color} absolute scale-x-0 group-hover:rotate-45 group-hover:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><span className={`w-3 h-0.5 bg-${color} absolute left-[28px] scale-x-0 group-hover:-rotate-45 group-hover:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><p className={`text-sm text-${color} font-bold pl-1 group-hover:translate-x-10 ease-in-out duration-500`}>READ MORE</p></div>
                            </div>
                ...
                <div id='benefitsViewport02' className='flex justify-end max-xl:flex-col-reverse max-xl:items-end max-xl:mt-20'>
                    <div className='w-7/12 relative rounded-bl-lg top-10 pl-[14%] max-2xl:rounded-none max-2xl:w-full max-2xl:top-0 850:pb-96 650:pl-10'>
                        <h2 className={`text-${color} font-bold mb-4 relative mt-20 650:mt-14`}>OUR PHILOSOPHY<span className={`absolute bottom-1 ml-1 bg-${color} h-0.5 w-2`}></span></h2>
                        ...
                        {PhilosophyGridData.map((el) => {
                            return (
                            <div key={el.index} className={`flex rounded-md w-[210px] mb-4 pl-4 hover:cursor-pointer hover-bg-${color} ease-in-out duration-500 group`}>
