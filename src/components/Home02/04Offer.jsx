...
export default function Offer() {
  ...
  const [currentSlideNumber, setCurrentSlideNumber] = useState(0);
    ...
    function triangleAnimation(categorie) {
      ...
      let remove = document.getElementsByClassName(`home02-offer-active-${color}`);
      remove[0].classList.remove(`home02-offer-active-${color}`);
      let target = document.getElementById(currentCategorie);
      target.classList.add(`home02-offer-active-${color}`);
    }
    ...
    return(
        <section className='bg-greyBackground relative z-10 font-NunitoSans text-center pb-48 bg-squareBackground bg-cover bg-[center_bottom_-9rem] max-xl:mt-32' id='goTopViewport'>
          <div className='flex font-Amiri text-white justify-center h-36 relative -top-[72px] w-10/12 m-auto max-xl:flex-col max-xl:top-0 650:w-full'>
            <div className={`relative flex items-center bg-${secondaryColor} rounded-l-lg group max-xl:rounded-lg`}>
              <span className={`text-8xl text-${slightBlue} absolute left-16 bottom-4 tracking-tighter`}>01</span>
            ...
            <div className={`relative flex items-center bg-${color} rounded-r-lg group max-xl:rounded-lg`}>
              <span className={`absolute left-16 bottom-4 tracking-tighter text-8xl text-${slightColor}`}>02</span>
          ...
          <h2 className={`text-${color} font-bold mb-4 relative w-40 m-auto max-xl:pt-36 850:mt-12`}><span className={`absolute bottom-1 left-0 bg-${color} h-0.5 w-2`}></span>WHAT WE OFFER<span className={`absolute bottom-1 ml-1 bg-${color} h-0.5 w-2`}></span></h2>
          ...
          <div className='flex justify-between w-[60%] w-[1170px] m-auto mb-12 max-xl:w-[80%] 1050-xl:flex-wrap 1050:grid 430-1050:grid-cols-2 430:grid-cols-1'>
                <div onClick={() => addActiveOffer('business', 'businessSlide', 0)} id='business' className={`relative bg-white bg-reportIcon bg-[center_top_1.2rem] bg-[length:50px_50px] bg-no-repeat border border-[#E6E6E6] home02-offer-active-${color} border-solid rounded w-[170px] hover:cursor-pointer hover-bg-${color} group ease-in-out duration-300 1050:mb-6 1050:justify-self-center 430:w-full`}>
                ...
                <div onClick={() => addActiveOffer('marketing', 'marketingSlide', 1)} id='marketing' className={`relative bg-white bg-moneyIcon bg-[center_top_1.2rem] bg-[length:50px_50px] bg-no-repeat border border-[#E6E6E6] border-solid rounded w-[170px] hover:cursor-pointer hover-bg-${color} group ease-in-out duration-300 1050:mb-6 1050:justify-self-center 430:w-full`}>
                ...
                <div onClick={() => addActiveOffer('partnership', 'partnershipSlide', 4)} id='partnership' className={`relative bg-white bg-paymentIcon bg-[center_top_1.2rem] bg-[length:50px_50px] bg-no-repeat border border-[#E6E6E6] border-solid rounded w-[170px] hover:cursor-pointer hover-bg-${color} group ease-in-out duration-300 1060:mt-8 1050:mb-6 1050:justify-self-center 430:w-full`}>
                ...
                <div onClick={() => addActiveOffer('innovation', 'innovationSlide', 5)} id='innovation' className={`relative bg-white bg-balanceIcon bg-[center_top_1.2rem] bg-[length:50px_50px] bg-no-repeat border border-[#E6E6E6] border-solid rounded w-[170px] hover:cursor-pointer hover-bg-${color} group ease-in-out duration-300 1060:w-5/12 1050-xl:w-full 1050-xl:mt-8 1050:mb-6 1050:justify-self-center 430:w-full`}>
          ...
          <div id='offerViewport' className='relative w-[63%] bg-white w-[1170px] left-[50%] translate-x-[-50%] shadow-[6px_5px_30px_0_rgb(0,0,0,0.12)] overflow-hidden rounded-md group max-xl:w-[90%]'>
            <div id='businessSlide' className='offerSlide-active offerSlide flex relative bg-white m-auto items-center max-xl:flex-col'>
              <div className='text-left ml-16 850:ml-[5%]'>
                ...
                <div className='flex items-center group/arrow relative max-xl:mb-10'><span className={`w-10 h-0.5 bg-${color} absolute scale-x-0 group-hover/arrow:scale-x-100 origin-left ease-in-out duration-500`}></span><span className={`w-3 h-0.5 top-[9px] left-[28px] bg-${color} absolute scale-x-0 group-hover/arrow:rotate-45 group-hover/arrow:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><span className={`w-3 h-0.5 bg-${color} absolute left-[28px] scale-x-0 group-hover/arrow:-rotate-45 group-hover/arrow:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><p className={`text-sm text-${color} font-bold pl-1 group-hover/arrow:translate-x-10 ease-in-out duration-500`}>READ MORE</p></div>
              </div>
              <div className='relative 430-650:ml-[15%] 430:ml-[22%]'>
            ...
            <div id='marketingSlide' className='offerSlide flex top-0 absolute translate-y-[100%] left-0 bg-white m-auto items-center max-xl:flex-col'>
              <div className='relative 430-650:mr-[15%] 430:mr-[22%]'>
              ...
              <div className='text-left ml-10 mr-20 850:mr-0 850:ml-[5%]'>
                <p className='font-Amiri text-3xl text-slightGrey mb-3 max-xl:mt-8'>Counsalting Service Include</p>
                <p className='text-greyText w-[400px] leading-8 mb-6 max-xl:w-auto max-xl:pr-8'>Change is opportunity. The challenges it presents may seem daunting, but we help you approach change with confidence, adapt with purpose and embrace.</p>
                <p className='text-greyText w-[400px] leading-8 mb-8 max-xl:w-auto max-xl:pr-8'>Our results solution combines implementation support, capability building and state-of-the-art diagnostic and analytic tools so you can continually change.</p>
                <div className='flex items-center group/arrow relative max-xl:mb-10'><span className={`w-10 h-0.5 bg-${color} absolute scale-x-0 group-hover/arrow:scale-x-100 origin-left ease-in-out duration-500`}></span><span className={`w-3 h-0.5 top-[9px] left-[28px] bg-${color} absolute scale-x-0 group-hover/arrow:rotate-45 group-hover/arrow:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><span className={`w-3 h-0.5 bg-${color} absolute left-[28px] scale-x-0 group-hover/arrow:-rotate-45 group-hover/arrow:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><p className={`text-sm text-${color} font-bold pl-1 group-hover/arrow:translate-x-10 ease-in-out duration-500`}>READ MORE</p></div>
            ...
            <div id='analyticSlide' className='offerSlide flex top-0 z-10 absolute translate-y-[100%] left-0 bg-white m-auto items-center max-xl:flex-col'>
              <div className='text-left ml-16 850:ml-[5%]'>
                <p className='font-Amiri text-3xl text-slightGrey mb-3 max-xl:mt-8'>Counsalting Service Include</p>
                <p className='text-greyText w-[400px] leading-8 mb-6 max-xl:w-auto max-xl:pr-8'>Change is opportunity. The challenges it presents may seem daunting, but we help you approach change with confidence, adapt with purpose and embrace.</p>
                <p className='text-greyText w-[400px] leading-8 mb-8 max-xl:w-auto max-xl:pr-8'>Our results solution combines implementation support, capability building and state-of-the-art diagnostic and analytic tools so you can continually change.</p>
              ...
              <div className='relative 430-1050:mr-[15%] 430:mr-[22%]'>
            ...
            <div id='entrepriseSlide' className='offerSlide flex top-0 z-10 absolute translate-y-[100%] left-0 bg-white m-auto items-center max-xl:flex-col'>
              <div className='relative 430-650:mr-[15%] 430:mr-[22%] my-5'>
              ...
              <div className='text-left ml-32 850:ml-[5%]'>
                <p className='font-Amiri text-3xl text-slightGrey mb-3 max-xl:mt-8'>Counsalting Service Include</p>
                <p className='text-greyText w-[400px] leading-8 mb-6 max-xl:w-auto max-xl:pr-8'>Change is opportunity. The challenges it presents may seem daunting, but we help you approach change with confidence, adapt with purpose and embrace.</p>
                <p className='text-greyText w-[400px] leading-8 mb-8 max-xl:w-auto max-xl:pr-8'>Our results solution combines implementation support, capability building and state-of-the-art diagnostic and analytic tools so you can continually change.</p>
                <div className='flex items-center group/arrow relative max-xl:mb-10'><span className={`w-10 h-0.5 bg-${color} absolute scale-x-0 group-hover/arrow:scale-x-100 origin-left ease-in-out duration-500`}></span><span className={`w-3 h-0.5 top-[9px] left-[28px] bg-${color} absolute scale-x-0 group-hover/arrow:rotate-45 group-hover/arrow:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><span className={`w-3 h-0.5 bg-${color} absolute left-[28px] scale-x-0 group-hover/arrow:-rotate-45 group-hover/arrow:scale-x-100 ease-linear duration-300 delay-500 origin-right`}></span><p className={`text-sm text-${color} font-bold pl-1 group-hover/arrow:translate-x-10 ease-in-out duration-500`}>READ MORE</p></div>
            ...
            <div id='partnershipSlide' className='offerSlide flex top-0 z-10 absolute translate-y-[100%] left-0 bg-white m-auto items-center max-xl:flex-col'>
              <div className='text-left ml-16 850:ml-[5%]'>
                <p className='font-Amiri text-3xl text-slightGrey mb-3 max-xl:mt-8'>Counsalting Service Include</p>
                <p className='text-greyText w-[400px] leading-8 mb-6 max-xl:w-auto max-xl:pr-8'>Change is opportunity. The challenges it presents may seem daunting, but we help you approach change with confidence, adapt with purpose and embrace.</p>
                <p className='text-greyText w-[400px] leading-8 mb-8 max-xl:w-auto max-xl:pr-8'>Our results solution combines implementation support, capability building and state-of-the-art diagnostic and analytic tools so you can continually change.</p>
            ...
            <div id='innovationSlide' className='offerSlide flex top-0 z-10 absolute translate-y-[110%] left-0 bg-white m-auto items-center max-xl:flex-col'>
              <div className='relative 430-650:mr-[15%] 430:mr-[22%]'>
