        ...
        <section className='mt-20 max-xl:px-[5%]'>
            ...
            <div className='flex max-xl:flex-col max-xl:items-center'>
                {InfoCardElement.map((el) => {
                    return(
                        <div key={el.index} className={`OfferCardBackground-${el.index} rounded-lg w-[370px] m-auto mb-8 relative group hover:cursor-pointer hover:shadow-[6px_5px_30px_0px_rgb(0,0,0,0.15)] ease-in-out duration-500 max-xl:mb-16 430:w-[300px] 430:h-[280px]`}>
            ...
            <div className='flex justify-between max-xl:flex-col max-xl:items-center'>
                {SlideCardElement.map((el) =>
                    ...
                    <div>
                        <p className='font-Amiri text-2xl mb-1 group-hover:text-white 650:text-lg'>{el.title}</p>
                        <p className='font-NunitoSans w-10/12 leading-7 text-[#616161] group-hover:text-white 650:text-sm'>Strategy experience and analytical expertise.</p>
                    </div>
