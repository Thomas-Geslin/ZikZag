...
export default function FlipElement() {
    return(
        <section className='mt-20 max-xl:px-[5%]'>
            ...
            <div className="flex justify-between relative max-xl:w-full max-xl:flex-col max-xl:items-center">
                <div className="flip-card hover:cursor-pointer max-xl:min-w-[310px] max-xl:mb-8">
                    <div className="flip-card-inner">
                        <div className="flip-card-front bg-card01Background bg-no-repeat bg-cover text-center text-white rounded-lg pb-14">
                ...
                <div className="flip-card hover:cursor-pointer max-xl:min-w-[310px]">
                    <div className="flip-card-inner">
                        <div className="flip-card-front bg-card03Background bg-no-repeat bg-cover text-center text-white rounded-lg pb-14">
                            <Image src={cardIcon02} alt='dessin de puzzle' className="w-12 m-auto pt-16 mb-6" />
