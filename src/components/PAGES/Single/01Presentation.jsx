...
export default function PresentationSingle() {
    return(
        <section className='relative w-[61%] min-w-[1150px] m-auto shadow-[6px_5px_30px_0px_rgb(0,0,0,0.12)] rounded-2xl flex my-20 px-24 py-16 max-xl:flex max-xl:flex-col max-xl:min-w-fit 850-xl:w-[60%] 850:w-[90%] 850:px-4 850:my-10 max-xl:items-center'>
            <Image src={women} alt="photo d'entreprise" className='rounded-xl w-[470px] 650:w-[310px]' />
            <Image src={line} alt="photo d'entreprise" className='absolute right-10 max-xl:hidden' />

            <div className='relative top-7'>
                <div className='bg-darkBlueBackground rounded py-8 px-28 relative -left-10 max-xl:left-0 850:px-8 850:inline-block'>
                ...
                <p className='text-slightGrey text-lg font-semibold mt-7 mb-4 pl-16 850:pl-0'>Position: <span className='text-greyText font-normal ml-2.5'>Chief Customer Officer</span></p>
                <p className='text-slightGrey text-lg font-semibold mb-4 pl-16 850:pl-0'>Responsibility: <span className='text-greyText font-normal ml-2.5'>Brand Development</span></p>
                <p className='text-slightGrey text-lg font-semibold mb-4 pl-16 850:pl-0'>Experience: <span className='text-greyText font-normal ml-2.5'>10 Years</span></p>
                <p className='text-slightGrey text-lg font-semibold mb-4 pl-16 850:pl-0'>Email: <span className='text-greyText font-normal ml-2.5'>chriss.moore@mail.com</span></p>
                <p className='text-slightGrey text-lg font-semibold mb-4 pl-16 850:pl-0'>Phone: <span className='text-greyText font-normal ml-2.5'>507 - 541 - 4567</span></p>

                <div className='flex items-center mt-10 pl-16 850:pl-0'>
