...
export default function TeamOurTeam() {
    ...
    return(
        <section className='mt-40'>
            <div className='flex items-center justify-center max-xl:flex-col max-xl:items-center'>
                <div className='ml-48 relative max-xl:ml-0 850:max-w-[90%]'>
                    <Image src={line} alt='ligne de décoration' className='absolute bottom-0 -left-28 850:hidden' />
                    <Image src={background} alt='réunion entreprise' className='rounded-lg relative' />
                    <Image src={man} alt='dessin de super-héros' className='absolute top-12 left-80 850:hidden' />
                </div>

                <div className='w-1/3 ml-60 max-xl:ml-0 850-xl:w-[70%] 850:w-[90%] max-xl:mt-20'>
                    ...
                    <div id='numberViewport' className='flex 650:flex-col'>
            ...
            <div className='px-12 mt-48 max-xl:mt-16 850:px-0'>
                <Swiper
                    modules={[Autoplay]}
                    slidesPerView={6}
                    loop
                    ...
                    speed={1000}
                >
                    <SwiperSlide className="w-40 min-w-[270px] rounded-lg py-14 px-10 mt-5 mb-10 group hover:shadow-[11px_10px_38px_0px_rgb(0,0,0,0.10)] ease-in duration-300 hover:cursor-pointer">
                    ...
                    <SwiperSlide className="w-40 min-w-[270px] rounded-md py-14 px-10 mt-5 mb-10 group hover:shadow-[11px_10px_38px_0px_rgb(0,0,0,0.10)] hover:cursor-pointer ease-in-out duration-300">
                        <div className='h-14 overflow-hidden'>
