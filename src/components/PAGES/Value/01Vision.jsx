...
export default function VisionValue() {
    return(
        <section className='overflow-hidden -mb-20'>
            <div className='flex justify-center mt-40 relative left-40'>
                <div className="w-1/4 max-xl:w-full relative">
                    ...
                    <h3 className="font-Amiri text-5xl text-slightGrey w-[95%] leading-tight mb-4 max-xl:w-full 650:text-4xl">Strategy is at the Heart of What We Do</h3>
                    <p className="text-greyText text-lg w-11/12 leading-8 mb-8 max-xl:w-full">Our vision is to inspire businesses to put employee wellbeing at the heart of everything they do. Our mission is to use employee wellbeing as a tool to champion positive change in the modern workplace.</p>
            ...
            <div className='px-12 relative -top-20'>
                <Swiper
                    modules={[Autoplay]}
                    slidesPerView={6}
                    loop
