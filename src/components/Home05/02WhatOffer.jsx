    ...
    return(
        <section className='text-center bg-Home05Offer bg-no-repeat bg-[bottom_left] bg-contain pb-20'>
            ...
            <div className='flex w-2/3 m-auto'>
                <div className='bg-white text-left relative mx-4 shadow-[3px_3px_20px_3px_#eae9e9] rounded-lg pl-10 group hover:bg-darkBlueBackground ease-in-out duration-300'>
