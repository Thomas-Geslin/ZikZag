...
export default function WhatOfferHome05() {
    return(
        <section className='text-center bg-Home05Offer bg-no-repeat bg-[bottom_left] bg-contain pb-20 relative z-10'>
            <h2 className='text-orange font-bold mb-4 relative w-40 m-auto max-xl:pt-10 850:mt-12'><span className='absolute bottom-1 left-0 bg-orange h-0.5 w-2'></span>WHAT WE OFFER<span className='absolute bottom-1 ml-1 bg-orange h-0.5 w-2'></span></h2>
            ...
            <div className='flex justify-center w-2/3 m-auto min-w-[1200px] max-xl:flex-col max-xl:items-center max-xl:min-w-fit'>
                <div className='bg-white w-[370px] text-left relative mx-4 shadow-[3px_3px_20px_3px_#eae9e9] rounded-lg pl-10 group hover:bg-darkBlueBackground ease-in-out duration-300 max-xl:mb-6 430:w-[290px]'>
                    ...
                    <span className='absolute h-px bg-[#e5e5e5] w-[90%] mt-6 group-hover:bg-orange ease-in-out duration-300 430:w-[86%]'></span>
                ...
                <div className='bg-white w-[370px] text-left relative mx-4 shadow-[3px_3px_20px_3px_#eae9e9] rounded-lg pl-10 group hover:bg-darkBlueBackground ease-in-out duration-300 430:w-[290px]'>
