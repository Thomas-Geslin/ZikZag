...
export default function HeaderHome05() {
    ...
    return(
        <header className='z-50 absolute top-0 right-0 left-0'>
            <div id='stickyHeader' className="flex font-Amiri text-white h-1.5 max-xl:hidden z-[100] relative">
                <span className='w-1/3 bg-darkBlueBackground'></span>
