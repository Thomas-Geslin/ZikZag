  ...
  useEffect(() => {
    ...
    return(
        <section className="z-10 flex justify-center items-center mt-24 mb-64 max-xl:flex-col max-xl:items-start 850:mt-14">
            <div id='aboutViewport' className="relative 430:w-[450px]">
                ...
                <Image id='aboutThirdReveal' src={line02} alt='ligne de décoration' className="absolute bottom-0 right-28 opacity-0 min-w-[217px] 850:w-5/12 850:right-48" />
                ...
                <Image id='aboutFifthReveal' src={line04} alt='ligne de décoration' className="absolute bottom-0 right-28 opacity-0 min-w-[217px] 850:w-5/12 850:right-48" />
            </div>
