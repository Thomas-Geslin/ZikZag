         ...
         <section className='relative overflow-hidden z-10'>
            ...
            <div className='bg-Home06Landing bg-center bg-cover h-[923px]'>
                ...
                <div className='shadow-[13px_11px_81px_0px_rgb(0,0,0,0.10)] backdrop-blur-[7.2px] rounded-3xl border border-solid border-white min-w-[600px] w-[40%] ml-auto relative top-60 right-64 pl-[70px] py-[60px] 850-1050:right-[10%] 850:min-w-fit 850:w-[80%] 850:mx-[5%] 850:left-0 430:pl-4 430:top-32'>
                    <h2 className={`text-${color} font-semibold mb-4 relative`}>KEEP YOUR FINANCIAL LIFE SIMPLE<span className={`absolute bottom-1 ml-1 bg-${color} h-0.5 w-2`}></span></h2>
                    ...
                    <div className='flex items-center 430:flex-col'>
                        <Link href='/Contacts' className="850:mr-auto"><button className={`text-sm font-semibold text-white rounded bg-${color} px-11 py-5 mr-4 430:mb-5 430:px-6 430:py-3 hover-bg-${secondaryColor} ease-in-out duration-300`}>LEARN MORE</button></Link>
                        <div className={`group bg-white px-7 py-6 rounded-full shadow-[5px_5px_15px_3px_#dddddd] hover-bg-${color} hover:cursor-pointer ease-linear duration-300 430:mr-auto`}><FontAwesomeIcon icon={faPlay} className={`w-4 text-${color} group-hover:text-white`} /></div>
