...
export default function FourOhFour() {
  return (
    <div>
        ...
        <main>
            <section className="bg-404Background bg-cover bg-no-repeat text-center text-white">
            ...
            <section className='flex flex-col items-center shadow-[6px_5px_30px_0px_rgb(0,0,0,0.12)] w-2/3 min-w-[1150px] 850-xl:min-w-[830px] max-xl:w-[90%] 850:text-center 850:min-w-fit m-auto rounded-t-2xl py-32 relative -top-20 -mb-20 bg-white'>
                <Image src={back404} alt='arrière plan' className='850:w-[90%]' />
                ...
                <div className='pt-4 relative mt-6 mb-5'>
                    <p className='bg-greyBackground text-[#7e7e7e] rounded w-[450px] p-3 850:w-[300px]'>Search ...</p><div className='absolute bottom-1 right-1 bg-darkBlueBackground p-3 rounded'><FontAwesomeIcon icon={faMagnifyingGlass} className='w-4 text-white' /></div>
                </div>
