...
import { PortfolioData3Col } from "../../datas/Portfolio/PortfolioData3Col"
...
export default function GalleryPortfolio() {
    ...
    return(
        <div class='font-NunitoSans'>
            <Head>
                <title>ZikZag | Portfolio Gallery</title>
            ...
            <main>
                <section className="bg-singlePortfolioStandardBackground bg-cover bg-no-repeat text-center text-white">
                    <h1 className="font-Amiri text-6xl pt-60 mb-6">Portfolio Gallery</h1>
                    <p className="font-semibold text-sm pb-48 z-10"><span className="opacity-50">HOME &gt; </span> PORTFOLIO GALLERY</p>
                </section>
                ...
                <div className='w-[62%] min-w-[1180px] m-auto text-center mb-40 max-xl:w-[90%] max-xl:min-w-fit'>
                    ...
                    <div className='grid grid-cols-3 mt-10 gap-6 650-xl:grid-cols-2 max-xl:w-[90%] max-xl:m-auto max-xl:pt-10 650:grid-cols-1'>
                        {PortfolioData3Col.slice(0, loadMore).map((el) => {
                            if(el.categorie.includes(categorieFilter)) {
                                return(
                                    <Reveal key={el.index} keyframes={revealBottom} duration={600} delay={el.delay} triggerOnce className="relative">
                    ...
                    {loadMore < PortfolioData3Col.length 
