        ...
        <div class='font-NunitoSans'>
            ...
            <main>
                <section className="bg-singleLayoutsStandardBackground bg-no-repeat text-center text-white">
                    ...
                    <p className="font-semibold text-sm pb-48 z-10 430:pb-20"><span className="opacity-50">HOME &gt; </span> BLOG GRID</p>
                </section>


                <div className='w-[62%] min-w-[1180px] m-auto mb-40 mt-10 1050-xl:min-w-[950px] 850-1050:min-w-[750px] 650-850:min-w-[560px] 430-650:min-w-[420px] 430:min-w-[310px]'>
                    <div className='grid grid-cols-3 relative -top-4 850-1050:grid-cols-2 850:grid-cols-1 gap-4'>
                        {ArticleData.slice(0, loadMore).map((el) => {
                            return(
                                <Link key={el.index} href='/Blog/BlogSingle/Standard'>
                                <div className='articleAppear mt-4 mb-6 relative border-solid border border-[#e5e5e5] rounded-lg p-5 hover:shadow-[6px_5px_30px_0px_rgb(0,0,0,0.10)] hover:border-transparent ease-in-out duration-300 hover:cursor-pointer min-w-[370px] 1050-xl:max-w-[300px] 850-1050:max-w-[350px] 650-850:max-w-[560px] 430-650:max-w-[420px] 430:min-w-[310px]'>
                                    <Image  src={el.background} alt='persone travaillant sur un ordinateur' className='w-[330px] rounded-lg 1050-xl:w-[250px] 850-1050:w-[310px] 650-850:w-[520px] 430-650:w-[380px] 430:w-[270px]' />
