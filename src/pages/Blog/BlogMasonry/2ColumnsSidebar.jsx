...
import { ArticleDataMasonrySidebar } from "../../../datas/Blog/ArticleDataMasonrySidebar"
import AsideArticle from "../../../components/BLOG/AsideArticle"

import link from '../../../public/assets/BLOG/BlogSingle/Link/link.svg'


export default function TwoColumnsSidebarMasonry() {
        ...
        <div class='font-NunitoSans'>
            ...
            <main>
                <section className="bg-singleLayoutsStandardBackground bg-cover bg-no-repeat text-center text-white">
                    <h1 className="font-Amiri text-6xl pt-60 mb-6">2 Columns + Sidebar</h1>
                    <p className="font-semibold text-sm pb-48 z-10"><span className="opacity-50">HOME &gt; </span> 2 COLUMNS + SIDEBAR</p>
                </section>
