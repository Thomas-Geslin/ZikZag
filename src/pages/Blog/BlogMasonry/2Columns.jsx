...
import { ArticleDataMasonry } from "../../../datas/Blog/ArticleDataMasonry"

import link from '../../../public/assets/BLOG/BlogSingle/Link/link.svg'


export default function TwoColumnsMasonry() {
    ...
    return(
        <div class='font-NunitoSans'>
            <Head>
                <title>ZikZag | 2 Columns Masonry</title>
            ...
            <main>
                <section className="bg-singleLayoutsStandardBackground bg-no-repeat text-center text-white">
                    <h1 className="font-Amiri text-6xl pt-60 mb-6">2 Columns</h1>
                    <p className="font-semibold text-sm pb-48 z-10"><span className="opacity-50">HOME &gt; </span> 2 COLUMNS</p>
                </section>


                <div className='mx-[19%] mt-12 flex flex-wrap justify-between'>
                    {ArticleDataMasonry.slice(0, loadMore).map((el) => {
                        return(
                            <Link key={el.index} href={el.href}>
                            {!el.background && <div className='mb-8'></div>}
                            <div className='mb-12 relative border-solid border border-[#e5e5e5] rounded-lg p-5 max-w-[570px] hover:shadow-[6px_5px_30px_0px_rgb(0,0,0,0.10)] hover:border-transparent ease-in-out duration-300 hover:cursor-pointer'>
