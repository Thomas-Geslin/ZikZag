...
import { ArticleDataMasonry4 } from "../../../datas/Blog/ArticleDataMasonry4"
...
export default function ThreeColumnsMasonry() {
    ...
    return(
        <div class='font-NunitoSans'>
            <Head>
                <title>ZikZag | 4 Columns Masonry</title>
            ...
            <main>
                <section className="bg-singleLayoutsStandardBackground bg-cover bg-no-repeat text-center text-white">
                    <h1 className="font-Amiri text-6xl pt-60 mb-6">4 Columns Full Width</h1>
                    <p className="font-semibold text-sm pb-48 z-10"><span className="opacity-50">HOME &gt; </span>  4 COLUMNS FULL WIDTH</p>
                </section>


                <div className='mx-[2%] relative mt-12 flex flex-wrap justify-between mt-20'>
                    {ArticleDataMasonry4.slice(0, loadMore).map((el) => {
                        return(
                            <Link key={el.index} href={el.href} className={`${el.class} relative`}>
                            {!el.background && <div className='mb-8'></div>}
                            <div className='relative mb-12 border-solid border border-[#e5e5e5] rounded-lg p-5 max-w-[440px] hover:shadow-[6px_5px_30px_0px_rgb(0,0,0,0.10)] hover:border-transparent ease-in-out duration-300 hover:cursor-pointer'>
                                {el.background && <Image  src={el.background} alt='persone travaillant sur un ordinateur' className='rounded-lg max-w-[400px]' />}
                ...
                {loadMore < ArticleDataMasonry4.length 
